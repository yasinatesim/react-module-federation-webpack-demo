													...
													if (b) {
														if (void 0 !== o.remotes) {
															...
															g(o.remotes, {
																...
																rootData: f
															}) || (u = null === u ? g.errors : u.concat(g.errors), c = u.length), b = e === c;
														} else b = !0;
														if (b) {
															if (void 0 !== o.runtime) {
																let e = o.runtime;
																...
																const i = c;
																if (!1 !== e) {
																	const e = { params: { allowedValues: n.anyOf[0].enum } };
																	null === u ? u = [e] : u.push(e), c++;
																}
																var v = i === c;
																if (s = s || v, !s) {
																	const t = c;
																	if (c === t) if ("string" == typeof e) {
																		if (e.length < 1) {
																			const e = { params: {} };
																			null === u ? u = [e] : u.push(e), c++;
																		}
																...
																c = r, null !== u && (r ? u.length = r : u = null), b = t === c;
															} else b = !0;
															if (b) {
																if (void 0 !== o.shareScope) {
																	...
																	if (n = n || P, !n) {
																		const t = c;
																		if (c === t) if (Array.isArray(e)) {
																			const t = e.length;
																			for (let r = 0; r < t; r++) {
																				let t = e[r];
																				const n = c;
																				if (c === n) if ("string" == typeof t) {
																					if (t.length < 1) {
																						const e = { params: {} };
																						null === u ? u = [e] : u.push(e), c++;
																					}
																...
																if (b) {
																	if (void 0 !== o.shareStrategy) {
																		...
																		const r = c;
																		if ("string" != typeof e) return D.errors = [{ params: { type: "string" } }], !1;
																		if ("version-first" !== e && "loaded-first" !== e) return D.errors = [{ params: { allowedValues: t.properties.shareStrategy.enum } }], !1;
																		b = r === c;
																	} else b = !0;
																	if (b) {
																		if (void 0 !== o.shared) {
																			...
																			A(o.shared, {
																				...
																				rootData: f
																			}) || (u = null === u ? A.errors : u.concat(A.errors), c = u.length), b = e === c;
																		} else b = !0;
																		if (b) {
																			if (void 0 !== o.dts) {
																				let e = o.dts;
																				...
																				if (s = s || j, !s) {
																					const r = c;
																					if (c === r) if (e && "object" == typeof e && !Array.isArray(e)) {
																						if (void 0 !== e.generateTypes) {
																							...
																							if (s = s || x, !s) {
																								const e = c;
																								if (c === e) if (t && "object" == typeof t && !Array.isArray(t)) {
																									if (void 0 !== t.tsConfigPath) {
																										const e = c;
																										if ("string" != typeof t.tsConfigPath) {
																											const e = { params: { type: "string" } };
																											null === u ? u = [e] : u.push(e), c++;
																										}
																										var O = e === c;
																									...
																									if (O) {
																										if (void 0 !== t.typesFolder) {
																											const e = c;
																											if ("string" != typeof t.typesFolder) {
																												const e = { params: { type: "string" } };
																												null === u ? u = [e] : u.push(e), c++;
																											}
																											O = e === c;
																										...
																										if (O) {
																											if (void 0 !== t.compiledTypesFolder) {
																												const e = c;
																												if ("string" != typeof t.compiledTypesFolder) {
																													const e = { params: { type: "string" } };
																													null === u ? u = [e] : u.push(e), c++;
																												}
																												O = e === c;
																											...
																											if (O) {
																												if (void 0 !== t.deleteTypesFolder) {
																													const e = c;
																													if ("boolean" != typeof t.deleteTypesFolder) {
																														const e = { params: { type: "boolean" } };
																														null === u ? u = [e] : u.push(e), c++;
																													}
																													O = e === c;
																												...
																												if (O) {
																													if (void 0 !== t.additionalFilesToCompile) {
																														let e = t.additionalFilesToCompile;
																														const r = c;
																														if (c === r) if (Array.isArray(e)) {
																															const t = e.length;
																															for (let r = 0; r < t; r++) {
																																const t = c;
																													...
																													if (O) {
																														if (void 0 !== t.compileInChildProcess) {
																															const e = c;
																															if ("boolean" != typeof t.compileInChildProcess) {
																																const e = { params: { type: "boolean" } };
																																null === u ? u = [e] : u.push(e), c++;
																															}
																															O = e === c;
																														...
																														if (O) {
																															if (void 0 !== t.compilerInstance) {
																																const e = c;
																																if ("string" != typeof t.compilerInstance) {
																																	const e = { params: { type: "string" } };
																																	null === u ? u = [e] : u.push(e), c++;
																																}
																																O = e === c;
																															...
																															if (O) {
																																if (void 0 !== t.generateAPITypes) {
																																	const e = c;
																																	if ("boolean" != typeof t.generateAPITypes) {
																																		const e = { params: { type: "boolean" } };
																																		null === u ? u = [e] : u.push(e), c++;
																																	}
																																	O = e === c;
																																...
																																if (O) {
																																	if (void 0 !== t.extractThirdParty) {
																																		let e = t.extractThirdParty;
																																		const r = c, n = c;
																																		let s = !1;
																																		const o = c;
																																		if ("boolean" != typeof e) {
																																		...
																																		if (s = s || k, !s) {
																																			...
																																			if (c === t) if (e && "object" == typeof e && !Array.isArray(e)) {
																																				const t = c;
																																				for (const t in e) if ("exclude" !== t) {
																																					const e = { params: { additionalProperty: t } };
																																					null === u ? u = [e] : u.push(e), c++;
																																					break;
																																				}
																																				if (t === c && void 0 !== e.exclude) {
																																					let t = e.exclude;
																																					if (c == c) if (Array.isArray(t)) {
																																						const e = t.length;
																																						for (let r = 0; r < e; r++) {
																																							let e = t[r];
																																							const n = c, s = c;
																																							...
																																							if (o) c = s, null !== u && (s ? u.length = s : u = null);
																																							else {
																																								const e = { params: {} };
																																								null === u ? u = [e] : u.push(e), c++;
																																							}
																																	...
																																	if (O) {
																																		if (void 0 !== t.extractRemoteTypes) {
																																			const e = c;
																																			if ("boolean" != typeof t.extractRemoteTypes) {
																																				const e = { params: { type: "boolean" } };
																																				null === u ? u = [e] : u.push(e), c++;
																																			}
																																			O = e === c;
																						...
																						if (T) {
																							if (void 0 !== e.consumeTypes) {
																								...
																								if (o = o || L, !o) {
																									const e = c;
																									if (c === e) if (r && "object" == typeof r && !Array.isArray(r)) {
																										if (void 0 !== r.typesFolder) {
																											const e = c;
																											if ("string" != typeof r.typesFolder) {
																												const e = { params: { type: "string" } };
																												null === u ? u = [e] : u.push(e), c++;
																											}
																											var E = e === c;
																										...
																										if (E) {
																											if (void 0 !== r.abortOnError) {
																												const e = c;
																												if ("boolean" != typeof r.abortOnError) {
																													const e = { params: { type: "boolean" } };
																													null === u ? u = [e] : u.push(e), c++;
																												}
																												E = e === c;
																											...
																											if (E) {
																												if (void 0 !== r.remoteTypesFolder) {
																													const e = c;
																													if ("string" != typeof r.remoteTypesFolder) {
																														const e = { params: { type: "string" } };
																														null === u ? u = [e] : u.push(e), c++;
																													}
																													E = e === c;
																												...
																												if (E) {
																													if (void 0 !== r.deleteTypesFolder) {
																														const e = c;
																														if ("boolean" != typeof r.deleteTypesFolder) {
																															const e = { params: { type: "boolean" } };
																															null === u ? u = [e] : u.push(e), c++;
																														}
																														E = e === c;
																													...
																													if (E) {
																														if (void 0 !== r.maxRetries) {
																															const e = c;
																															if ("number" != typeof r.maxRetries) {
																														...
																														if (E) {
																															if (void 0 !== r.consumeAPITypes) {
																																const e = c;
																																if ("boolean" != typeof r.consumeAPITypes) {
																																	const e = { params: { type: "boolean" } };
																																	null === u ? u = [e] : u.push(e), c++;
																																}
																																E = e === c;
																															...
																															if (E) {
																																...
																																if (E) {
																																	if (void 0 !== r.remoteTypeUrls) {
																																		let e = r.remoteTypeUrls;
																																		const t = c, n = c;
																																		let s = !1;
																																		const o = c;
																																		...
																																		if (s = s || R, !s) {
																																			const t = c;
																																			if (c === t) if (e && "object" == typeof e && !Array.isArray(e)) for (const t in e) {
																																				let r = e[t];
																																				const n = c;
																																				if (c === n) if (r && "object" == typeof r && !Array.isArray(r)) {
																																					let e;
																																					if (void 0 === r.api && (e = "api") || void 0 === r.zip && (e = "zip")) {
																																						const t = { params: { missingProperty: e } };
																																						null === u ? u = [t] : u.push(t), c++;
																																					} else {
																																						const e = c;
																																						for (const e in r) if ("alias" !== e && "api" !== e && "zip" !== e) {
																																							const t = { params: { additionalProperty: e } };
																																							null === u ? u = [t] : u.push(t), c++;
																																							break;
																																						}
																																						if (e === c) {
																																							...
																																							if (C) {
																																								if (void 0 !== r.api) {
																																									const e = c;
																																									if ("string" != typeof r.api) {
																																										const e = { params: { type: "string" } };
																																										null === u ? u = [e] : u.push(e), c++;
																																									}
																																									C = e === c;
																																								} else C = !0;
																																								if (C) if (void 0 !== r.zip) {
																																									const e = c;
																																									if ("string" != typeof r.zip) {
																																										const e = { params: { type: "string" } };
																																										null === u ? u = [e] : u.push(e), c++;
																																									}
																																									C = e === c;
																																	...
																																	if (E) {
																																		...
																																		if (E) {
																																			...
																																			if (E) if (void 0 !== r.typesOnBuild) {
																																				const e = c;
																																				if ("boolean" != typeof r.typesOnBuild) {
																																					const e = { params: { type: "boolean" } };
																																					null === u ? u = [e] : u.push(e), c++;
																																				}
																																				E = e === c;
																								...
																								if (T) {
																									...
																									if (T) {
																										if (void 0 !== e.implementation) {
																											const t = c;
																											if ("string" != typeof e.implementation) {
																												const e = { params: { type: "string" } };
																												null === u ? u = [e] : u.push(e), c++;
																											}
																											T = t === c;
																										...
																										if (T) {
																											...
																											if (T) if (void 0 !== e.displayErrorInTerminal) {
																												const t = c;
																												if ("boolean" != typeof e.displayErrorInTerminal) {
																													const e = { params: { type: "boolean" } };
																													null === u ? u = [e] : u.push(e), c++;
																												}
																												T = t === c;
																				...
																				c = n, null !== u && (n ? u.length = n : u = null), b = r === c;
																			} else b = !0;
																			if (b) {
																				if (void 0 !== o.experiments) {
																					...
																					if (c === r) {
																						...
																						if (void 0 !== e.asyncStartup) {
																							const t = c;
																							if ("boolean" != typeof e.asyncStartup) return D.errors = [{ params: { type: "boolean" } }], !1;
																							var $ = t === c;
																						} else $ = !0;
																						if ($) {
																							if (void 0 !== e.externalRuntime) {
																								const t = c;
																								if ("boolean" != typeof e.externalRuntime) return D.errors = [{ params: { type: "boolean" } }], !1;
																								$ = t === c;
																							} else $ = !0;
																							if ($) {
																								if (void 0 !== e.provideExternalRuntime) {
																									const t = c;
																									if ("boolean" != typeof e.provideExternalRuntime) return D.errors = [{ params: { type: "boolean" } }], !1;
																									$ = t === c;
																								} else $ = !0;
																								if ($) if (void 0 !== e.optimization) {
																				...
																				if (b) {
																					if (void 0 !== o.bridge) {
																						...
																						if (c === t) {
																							...
																							{
																								const t = c;
																								for (const t in e) if ("enableBridgeRouter" !== t && "disableAlias" !== t) return D.errors = [{ params: { additionalProperty: t } }], !1;
																								if (t === c) {
																									if (void 0 !== e.enableBridgeRouter) {
																										const t = c;
																										if ("boolean" != typeof e.enableBridgeRouter) return D.errors = [{ params: { type: "boolean" } }], !1;
																										var q = t === c;
																									} else q = !0;
																									if (q) if (void 0 !== e.disableAlias) {
																										const t = c;
																										if ("boolean" != typeof e.disableAlias) return D.errors = [{ params: { type: "boolean" } }], !1;
																										q = t === c;
																									} else q = !0;
																								}
																							}
																					...
																					if (b) {
																						if (void 0 !== o.virtualRuntimeEntry) {
																							const e = c;
																							if ("boolean" != typeof o.virtualRuntimeEntry) return D.errors = [{ params: { type: "boolean" } }], !1;
																							b = e === c;
																						} else b = !0;
																						if (b) {
																							if (void 0 !== o.dev) {
																								...
																								if (n = n || V, !n) {
																									...
																									if (c === t) if (e && "object" == typeof e && !Array.isArray(e)) {
																										const t = c;
																										for (const t in e) if ("disableLiveReload" !== t && "disableHotTypesReload" !== t && "disableDynamicRemoteTypeHints" !== t) {
																											const e = { params: { additionalProperty: t } };
																											null === u ? u = [e] : u.push(e), c++;
																											break;
																										}
																										if (t === c) {
																											if (void 0 !== e.disableLiveReload) {
																												const t = c;
																												if ("boolean" != typeof e.disableLiveReload) {
																													const e = { params: { type: "boolean" } };
																													null === u ? u = [e] : u.push(e), c++;
																												}
																												var w = t === c;
																											...
																											if (w) {
																												if (void 0 !== e.disableHotTypesReload) {
																													const t = c;
																													if ("boolean" != typeof e.disableHotTypesReload) {
																														const e = { params: { type: "boolean" } };
																														null === u ? u = [e] : u.push(e), c++;
																													}
																													w = t === c;
																												} else w = !0;
																												if (w) if (void 0 !== e.disableDynamicRemoteTypeHints) {
																													const t = c;
																													if ("boolean" != typeof e.disableDynamicRemoteTypeHints) {
																														const e = { params: { type: "boolean" } };
																														null === u ? u = [e] : u.push(e), c++;
																													}
																													w = t === c;
																							...
																							if (b) {
																								if (void 0 !== o.manifest) {
																									...
																									if (n = n || F, !n) {
																										...
																										if (c === t) if (e && "object" == typeof e && !Array.isArray(e)) {
																											const t = c;
																											for (const t in e) if ("filePath" !== t && "disableAssetsAnalyze" !== t && "fileName" !== t && "additionalData" !== t) {
																												const e = { params: { additionalProperty: t } };
																												null === u ? u = [e] : u.push(e), c++;
																												break;
																											}
																											if (t === c) {
																												...
																												if (N) {
																													...
																													if (N) {
																														...
																														if (N) if (void 0 !== e.additionalData) {
																															const t = c;
																															if (!(e.additionalData instanceof Function)) {
																																const e = { params: {} };
																																null === u ? u = [e] : u.push(e), c++;
																															}
																															N = t === c;
																								...
																								if (b) {
																										...
																										if (c === t) {
																											if (!Array.isArray(e)) return D.errors = [{ params: { type: "array" } }], !1;
																											{
																												...
																												for (let r = 0; r < t; r++) {
																													...
																													if (o = o || z, !o) {
																														const e = c;
																														if (c === e) if (Array.isArray(t)) if (t.length > 2) {
																															const e = { params: { limit: 2 } };
																															null === u ? u = [e] : u.push(e), c++;
																														} else if (t.length < 2) {
																															const e = { params: { limit: 2 } };
																															null === u ? u = [e] : u.push(e), c++;
																													...
																													if (c = s, null !== u && (s ? u.length = s : u = null), n !== c) break;
																												}
																											}
																										}
																										b = t === c;
																									...
																									if (b) {
																										if (void 0 !== o.getPublicPath) {
																											const e = c;
																											if ("string" != typeof o.getPublicPath) return D.errors = [{ params: { type: "string" } }], !1;
																											b = e === c;
																										} else b = !0;
																										if (b) {
																											if (void 0 !== o.dataPrefetch) {
																												const e = c;
																												if ("boolean" != typeof o.dataPrefetch) return D.errors = [{ params: { type: "boolean" } }], !1;
																												b = e === c;
																											} else b = !0;
																											if (b) if (void 0 !== o.implementation) {
																												const e = c;
																												if ("string" != typeof o.implementation) return D.errors = [{ params: { type: "string" } }], !1;
																												b = e === c;
																											} else b = !0;
																										}
																									}
...
var e, validate, ModuleFederationPlugin_check_default, t, r, n, s, p, h, b, v;
var init_ModuleFederationPlugin_check = require_runtime.__esmMin((() => {
	e = /^(?:[A-Za-z]:[\\/]|\\\\|\/)/;
	validate = D;
	ModuleFederationPlugin_check_default = D;
	t = {
		definitions: {
			AmdContainer: {
				type: "string",
			...
			Remotes: { anyOf: [{
				type: "array",
				items: { anyOf: [{ $ref: "#/definitions/RemotesItem" }, { $ref: "#/definitions/RemotesObject" }] }
			}, { $ref: "#/definitions/RemotesObject" }] },
			RemotesConfig: {
				type: "object",
				additionalProperties: !1,
				properties: {
					external: { anyOf: [{ $ref: "#/definitions/RemotesItem" }, { $ref: "#/definitions/RemotesItems" }] },
					shareScope: { anyOf: [{
						type: "string",
						minLength: 1
					}, {
			...
			Shared: { anyOf: [{
				type: "array",
				items: { anyOf: [{ $ref: "#/definitions/SharedItem" }, { $ref: "#/definitions/SharedObject" }] }
			...
			SharedObject: {
				type: "object",
				additionalProperties: { anyOf: [{ $ref: "#/definitions/SharedConfig" }, { $ref: "#/definitions/SharedItem" }] }
			},
		...
		additionalProperties: !1,
		properties: {
			async: { anyOf: [{ type: "boolean" }, {
				type: "object",
				properties: {
					eager: { anyOf: [{ instanceof: "RegExp" }, { instanceof: "Function" }] },
			...
			dts: { anyOf: [{ type: "boolean" }, {
				type: "object",
				properties: {
					generateTypes: { anyOf: [{ type: "boolean" }, {
						type: "object",
						properties: {
							...
							extractThirdParty: { anyOf: [{ type: "boolean" }, {
								type: "object",
								properties: { exclude: {
									type: "array",
					...
					consumeTypes: { anyOf: [{ type: "boolean" }, {
						...
						properties: {
							...
							remoteTypeUrls: { anyOf: [{ instanceof: "Function" }, {
								type: "object",
...
//#endregion
init_ModuleFederationPlugin_check();
Object.defineProperty(exports, 'ModuleFederationPlugin_check_exports', {
  enumerable: true,
  get: function () {
    return ModuleFederationPlugin_check_exports;
  }
});
exports.default = ModuleFederationPlugin_check_default;
Object.defineProperty(exports, 'init_ModuleFederationPlugin_check', {
  enumerable: true,
  get: function () {
    return init_ModuleFederationPlugin_check;
  }
});
