...
//#region src/schemas/container/ModuleFederationPlugin.ts
var ModuleFederationPlugin_exports = /* @__PURE__ */ require_runtime.__exportAll({ default: () => ModuleFederationPlugin_default });
var ModuleFederationPlugin_default;
var init_ModuleFederationPlugin = require_runtime.__esmMin((() => {
	ModuleFederationPlugin_default = {
		definitions: {
			AmdContainer: {
					...
					properties: {
						generateTypes: { anyOf: [{ type: "boolean" }, {
							...
							properties: {
								...
								afterGenerate: {
									description: "Hook called after federated types are generated and before assets are emitted",
									instanceof: "Function"
								}
							}
						}] },
...
exports.default = ModuleFederationPlugin_default;
Object.defineProperty(exports, 'init_ModuleFederationPlugin', {
  enumerable: true,
  get: function () {
    return init_ModuleFederationPlugin;
  }
});
